const SearchResult = ({doctor}) => {
  return (
    <div date-testid="suggestion-item" className="w-full h-full flex items-center justify-start gap-2 py-2 hover:bg-neutral-200 cursor-pointer px-2 rounded-md duration-150">
